...
uint32_t addr_1 = 0x50000000;
uint32_t addr_2 = 0x50001000;
//-----------------------------------------------------
...
static int testresult8 = 0; // To verify test 8 result
//-----------------------------------------------------
...
//-----All 0 to memory-------------------
    ...
    {	
		data_wrt = 0;
		csr_write_simple(data_wrt, addr_1 + (4*count));
		data_rd = csr_read_simple(addr_1 + (4*count));
		
		printf("Address: %lx", addr_1 + (4*count));
		printf("\n");
...
//-----All 1 to memory-------------------
    ...
    {	
		data_wrt = 1;
		csr_write_simple(data_wrt, addr_2 + (4*count));
		data_rd = csr_read_simple(addr_2 + (4*count));
		
		printf("Address: %lx", addr_2 + (4*count));
		printf("\n");
		printf("Data written: %lu", data_wrt);
		printf("\n");
		printf("Data read: %lu", data_rd);
