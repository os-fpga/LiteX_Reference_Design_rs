...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(75e6), with_led_chaser=True, axigpio = False, with_video_terminal=False, **kwargs):
...
def main():
    ...
    parser.add_argument("--axigpio",            action="store_true",     help="UART IP integrated by RS" )
