...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(75e6), with_led_chaser=True, axiram = False, with_video_terminal=False, **kwargs):
...
def main():
    ...
    parser.add_argument("--axiram",            action="store_true",     help="UART IP integrated by RS" )
